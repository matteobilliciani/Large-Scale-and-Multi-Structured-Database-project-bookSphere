# Script per eseguire lo Spike Test
# Performance Test - BookSphere

Write-Host "================================================" -ForegroundColor Cyan
Write-Host "  BookSphere - Spike Test" -ForegroundColor Yellow
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Test Configuration:" -ForegroundColor Green
Write-Host "  - Normal Load: 10 users" -ForegroundColor White
Write-Host "  - Spike Load: 200 users (instant)" -ForegroundColor White
Write-Host "  - Spike Duration: 60 seconds" -ForegroundColor White
Write-Host "  - Goal: Test resilience to traffic spikes" -ForegroundColor White
Write-Host ""
...
Write-Host ""
Write-Host "Starting Spike Test..." -ForegroundColor Yellow
Write-Host ""
