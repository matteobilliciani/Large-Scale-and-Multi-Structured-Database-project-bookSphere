...
public class AdminCatalogService {
    ...
    public AuthorDTO addAuthor(AuthorDTO authorDTO) {
        ...
        // ID will be generated by MongoDB, ensure it's null before saving
        authorDocument.setId(null);
    ...
    public AuthorDTO updateAuthor(@ValidObjectId String id, AuthorDTO authorDTO) {
    ...
    public void deleteAuthor(@ValidObjectId String id) {
